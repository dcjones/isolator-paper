...
\includegraphics[width=\textwidth]{analysis/cardio/ACOT9-comparison.pdf}
\includegraphics[width=\textwidth]{analysis/cardio/IMMT-comparison.pdf}
\includegraphics[width=\textwidth]{analysis/cardio/LTBP4-comparison.pdf}
\end{figure}
\begin{figure}[H]
\ContinuedFloat
\includegraphics[width=\textwidth]{analysis/cardio/OBSL1-comparison.pdf}
\includegraphics[width=\textwidth]{analysis/cardio/OSBPL1A-comparison.pdf}
\includegraphics[width=\textwidth]{analysis/cardio/PALM-comparison.pdf}
\includegraphics[width=\textwidth]{analysis/cardio/TNNT2-comparison.pdf}
...
%% TODO: which benchmark should we use to explore these problems? Maybe the
% SEQC transcript "consistency" benchmark? Regardless, it seems I didn't save
% any of this data locally so I have to spin up an instance.
% Fuck, I've paid about $600 in fees. I need to stop this thing.
...
%This paper argues that posterior mean estimates have some practical benefits.
%And reporting non-zero estimates in all cases is justifiable from a Bayesian
%...

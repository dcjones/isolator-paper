...
similarly $d$ by $0.75a + 0.25b$. To capture the notion of conistency, we
...
during sampling, Isolator is uniquely able to compute posterior
...
points so it did not easily lend itself to analysis using pairwise

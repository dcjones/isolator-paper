...
\title{Isolator: accurate and stable analysis of isoform-level expression in RNA-Seq experiments}
...
%\affil[3]{Institute for Molecular Bioscience, The University of Queensland. Brisbane. Australia}
...
be in agreement (``coherent'', in our terminology) we should expect $c \approx
...
reduced accuracy of posterior mean estimates, demonstrating that coherence and
